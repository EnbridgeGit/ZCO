REPORT  zbpci009_manactual MESSAGE-ID zs.
************************************************************************
...
*           p_file    TYPE        string DEFAULT 'C:\SAPTEMP\MANActual.csv', "TR995
            p_file    TYPE        string DEFAULT 'H:\SAPTEMP\MANActual.csv', "TR995
...
FORM get_db_data.
  ...
  SELECT paledger gjahr perde kstar rbeln bukrs wwsub wwser wwprg wwrat vvbvl vvbrv belnr wwsld
...
*Set the hard-coded values.
  ...
  LOOP AT t_ce11100_sum INTO s_ce11100.
    ...
    CASE s_ce11100-wwrat.
      WHEN '1' OR '01' OR '10' OR 'M1' OR 'M2' OR ''.
...
*Gas volume
    IF s_ce11100-vvbvl <> 0.
      ...
      CASE s_ce11100-wwrat.
        ...
        WHEN 'T-1' OR 'T-3'.
          lv_account = 'D_1120_vol'.
        WHEN OTHERS.
          CASE s_ce11100-wwsub.
            WHEN 'CF'.
              lv_account = 'D_1123_vol'.
            WHEN 'DC'.
              IF s_ce11100-wwrat = 'M5A'.
                lv_account = 'D_1128_vol'.
              ELSE.
...
*Revenue
    IF s_ce11100-vvbrv <> 0.
      IF s_ce11100-wwsub = 'SS' OR s_ce11100-wwsub = 'SD'.
        CASE s_ce11100-wwrat.
          WHEN '1' OR '01' OR '10' OR '20' OR '30' OR '100'.
