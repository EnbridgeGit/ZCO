...
SELECT  PERIO KNDNR WWSBU WWSCT WWSEG WWRAT WWSER WERKS
        WWDVS WWRGN ARTNR PRDHA BUDAT VKORG KSTAR WWLOB
        WWPRG WWSUB VVBRV VVURV VVBVL VVUVL VVCUT
  INTO  TABLE ITABLE
  FROM  CE11100
 WHERE  BUKRS = P_BUKRS
   AND  KOKRS = P_KOKRS
...
FORM FIELDCAT_INIT USING RT_FIELDCAT TYPE SLIS_T_FIELDCAT_ALV.
  ...
  LS_FIELDCAT-REPTEXT_DDIC  = 'BLANK'.
  APPEND LS_FIELDCAT TO  RT_FIELDCAT.
  ...
  LS_FIELDCAT-REPTEXT_DDIC  = 'SALES ORG.'.
  APPEND LS_FIELDCAT TO  RT_FIELDCAT.

  LS_FIELDCAT-FIELDNAME     = 'KSTAR'.
  LS_FIELDCAT-COL_POS       = 17.
  LS_FIELDCAT-REPTEXT_DDIC  = 'COST ELEM'.
  APPEND LS_FIELDCAT TO  RT_FIELDCAT.

  LS_FIELDCAT-FIELDNAME     = 'WWLOB'.
  LS_FIELDCAT-COL_POS       = 18.
  LS_FIELDCAT-REPTEXT_DDIC  = 'LINE OF BUS.'.
  APPEND LS_FIELDCAT TO  RT_FIELDCAT.

  LS_FIELDCAT-FIELDNAME     = 'WWPRG'.
  LS_FIELDCAT-COL_POS       = 19.
  LS_FIELDCAT-REPTEXT_DDIC  = 'PROGRAM'.
  APPEND LS_FIELDCAT TO  RT_FIELDCAT.

  LS_FIELDCAT-FIELDNAME     = 'WWSUB'.
  LS_FIELDCAT-COL_POS       = 20.
  LS_FIELDCAT-REPTEXT_DDIC  = 'SUB PROGRAM'.
  APPEND LS_FIELDCAT TO  RT_FIELDCAT.
  ...
  LS_FIELDCAT-FIELDNAME     = 'VVURV'.
  LS_FIELDCAT-COL_POS       = 22.
  LS_FIELDCAT-REPTEXT_DDIC  = 'UNBILLED REV'.
  APPEND LS_FIELDCAT TO  RT_FIELDCAT.
  ...
  LS_FIELDCAT-FIELDNAME     = 'VVUVL'.
  LS_FIELDCAT-COL_POS       = 24.
  LS_FIELDCAT-REPTEXT_DDIC  = 'UNBILLED VOL'.
  APPEND LS_FIELDCAT TO  RT_FIELDCAT.
