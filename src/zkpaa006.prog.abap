REPORT ZKPAA006 MESSAGE-ID ZF.
************************************************************************
*  Author    : Glenn Ymana                        SAP : East
*  Date      : March 2010                Program Type : Interface
*  Issue Log : TR811
*
************************************************************************
*  Brief Description:
*  - This program is used for the assignment of FI revenue postings
*    via transaction FB01L (Was created based on program ZKPAA005)
************************************************************************
* ---------------------- CHANGE LOG ------------------------------------
...
CONSTANTS: G_TCODE LIKE TSTC-TCODE VALUE 'FB01L'.
...
* convert dates to user-default format
  ...
  PERFORM BDC_FIELD  USING 'BKPF-LDGRP' ZBBKPF-LDGRP.
