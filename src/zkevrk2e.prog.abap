...
* Pufferbereiche für Treffermengen und aufgesammeltes für Insert
* bzw. Update.
...
* globale ranges für Vorgamgsart besetzen
  CLEAR: G-R_VRGAR.
  REFRESH: G-R_VRGAR.
...
*--------------------------------------------
*
*     Verarbeiten von G_TH_CE1 für eine Objektnummer
...
*--------------------------------------------
*
*     Konsistenzcheck für Einzelposten.
*     Operiert auf Work-Area von CE1%ERK und beschränkt sich
*     zunächst auf's Zählen von "schlechten" Feldinhalten.
*
*--------------------------------------------
...
*--------------------------------------------
*
*     Verarbeiten von G_TH_CE2 für eine Objektnummer
*     und Collecten in G_TH_CE3.
*
*--------------------------------------------
...
*
*     Konsistenzcheck für Einzelposten.
*     Operiert auf Work-Area von CE2%ERK und beschränkt sich
*     zunächst auf's Zählen von "schlechten" Feldinhalten.
*
*--------------------------------------------
